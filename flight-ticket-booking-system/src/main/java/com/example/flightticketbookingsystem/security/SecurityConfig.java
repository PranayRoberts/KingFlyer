...
//        http.cors().disable();
        ...
        http.authorizeRequests().antMatchers(GET,"/admin/register/**").hasAnyAuthority("ADMIN");
        http.authorizeRequests().antMatchers(GET,"/api/user/get_details").hasAnyAuthority("USER","ADMIN");
        http.authorizeRequests().antMatchers(GET,"/api/user/modify_details").hasAnyAuthority("USER","ADMIN");
